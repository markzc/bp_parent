	   ...
	   <div class="panel">
	       ...
	       <div class="panel-header">
	        ...
	        <div class="panel-content">
				<ul>
					<li><a href="${ctx}/sysadmin/messageAction_list" target="main" id="aa_3" onclick="linkHighlighted(this)">我的留言板</a></li>
					<li><a href="${ctx}/sysadmin/taskAction_list.action" target="main" id="aa_2" onclick="linkHighlighted(this)">我的代办任务</a></li>
					<li><a href="${ctx}/feedbackAction_list.action" target="main" id="aa_1" onclick="linkHighlighted(this)">意见反馈</a></li>
				</ul>
	        </div>
		...
		<div class="sidebar_t_r"></div>
 	    ...
 	    <div class="panel">
	        ...
	        <a href="#" onmousemove="javascript:showMenu('customerMenu');">自定义菜单</a>
		        	...
		        	<div id="fastMenu" style="padding-left: 20px" class="panel-content">
			        	<ul id="fastMenuShow"  >
			        		<li><a href="${ctx}/cargo/exportAction_contractList" target="main"  >合同管理</a></li>
							<li><a href="${ctx}/cargo/financeAction_list" target="main" >财务管理</a></li>
							<li><a href="${ctx}/stat/statChartAction_productsale" target="main" >产品销售排行</a></li>
			        	</ul>
		        	</div>
		        	...
		        	<div id="customerMenu">
				        ...
				        <ul class="box">
			        		<c:forEach items="${mlist }" var="module">
								<li><a href="${ctx}/${module.curl}" target="main">${module.name }</a></li>
			        		</c:forEach>
						</ul>
			        		<img src="${ctx}/skin/default/images/notice.gif" style="margin-right:5px;" border="0" />
			        		<a href="javascript:void(0);" target="main" ><font color="gray">编辑</font></a>
			        	</div>
...
<div id="sidebar" class="sidebar">
    ...
    <div class="panel">
        ...
        <div class="panel-content">
			<ul>
				<li><a href="${ctx }/sysadmin/userAction_sysuser" id="aa_2" onclick="linkHighlighted(this)" target="main">个人信息修改</a></li>						
				<li><a href="${ctx}/sysFeedbackAction_list" id="aa_2" target="main" onclick="linkHighlighted(this)">系统使用反馈</a></li>						
			</ul>
        </div>
    </div>
    </div>
