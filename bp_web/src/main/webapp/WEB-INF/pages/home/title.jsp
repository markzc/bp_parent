...
<script language="javascript">
	...
	function doLoginDiv(){
		window.parent.main.location.href="${ctx}/sysadmin/userAction_sysuser";
		ShowLoginDiv();
	}
...
<div class="PositionFrame_black" id="PositionFrame"></div>
	...
	<div style="width:1700px;position:absolute;padding-top:20px;">
		<iframe width="700" scrolling="no" height="70" frameborder="0" allowtransparency="true" src="http://i.tianqi.com/index.php?c=code&id=2&icon=1&py=beijing&num=3"></iframe>
	</div>
