    ...
    <div>
		<table class="commonTable" cellspacing="1">
			...
			<tr>
	            ...
	            <td class="tableContent">
	            <c:if test="${resolution == 1}">
					已修改
				</c:if>
				<c:if test="${resolution == 2}">
					无需修改
				</c:if>
				<c:if test="${resolution == 3}">
					重复问题
				</c:if>
				<c:if test="${resolution == 4}">
					描述不完整
				</c:if>
				<c:if test="${resolution == 5}">
					无法再现
				</c:if>
				<c:if test="${resolution == 6}">
					其他
				</c:if></td>
	        </tr>	
	        <tr>
