...
<li id="new"><a href="#" onclick="formSubmit('packingListAction_printPacking','_self');this.blur();">打印</a></li>
<li id="update"><a href="#" onclick="formSubmit('packingListAction_toupdate','_self');this.blur();">修改</a></li>
<li id="delete"><a href="#" onclick="formSubmit('${ctx}/cargo/packingListAction_Delete','_self');this.blur();">删除</a></li>
<li id="new"><a href="#" onclick="formSubmit('packingListAction_weituo','_self');this.blur();">委托</a></li>
</ul>
  </div>
</div>
</div>
...
${page.links}
	...
	<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" align="left">
		...
		<c:if test="${o.state==1}"><b><font color="green">已委托</font></b></c:if>
		</td>
	</tr>
	</c:forEach>
