...
<li id="submit"><a href="#" onclick="formSubmit('exportAction_printExport','_self');this.blur();">打印</a></li>
<li id="back"><a href="#" onclick="formSubmit('exportAction_cancel','_self');this.blur();">取消</a></li>
<li id="work_assign"><a href="#" onclick="formSubmit('exportAction_exportE','_self');this.blur();">电子审批</a></li>
...
<table id="ec_table" class="tableRegion" width="98%" >
	...
	<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
		...
		<td>
			...
			<c:if test="${o.state == 1}" >报运失败</c:if>
			<c:if test="${o.state == 2}" >报运成功</c:if>
		</td>
	</tr>
	</c:forEach>
