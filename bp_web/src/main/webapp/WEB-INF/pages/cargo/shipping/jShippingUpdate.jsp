    ...
    <div>
		<table class="commonTable" cellspacing="1">
	        ...
	        <tr>
	            ...
	            <td class="tableContent">
	            	<input style="width:30px;height: 15px;" type="radio" name="isBatch" value="1" <c:if test="${isBatch==1}">checked="checked"</c:if>>是</input>
	            	<input style="width:30px;height: 15px;" type="radio" name="isBatch" value="0" <c:if test="${isBatch==0}">checked="checked"</c:if>>否</input>
	            </td>
	        
	            <td class="columnTitle">是否转船：</td>
	            <td class="tableContent">
	           		<input style="width:30px;height: 15px;" type="radio" name="isTrans" value="1" <c:if test="${isTrans==1}">checked="checked"</c:if>>是</input>
	            	<input style="width:30px;height: 15px;" type="radio" name="isTrans" value="0" <c:if test="${isTrans==0}">checked="checked"</c:if>>否</input>
	            </td>
	        </tr>	
	        <tr>
